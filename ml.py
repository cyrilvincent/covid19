...
modelnb10 = pipe.make_pipeline(pp.PolynomialFeatures(4), sklm.Ridge())
x10 = df10.ix.values.reshape(-1,1)
y = df10.NbCas
modelnb10.fit(x10, y)
scorenb10 = modelnb10.score(x10,y)
modeldc10 = pipe.make_pipeline(pp.PolynomialFeatures(4), sklm.Ridge())
y = df10.DC
modeldc10.fit(x10, y)
scoredc10 = modeldc10.score(x10,y)
modelnblift = pipe.make_pipeline(pp.PolynomialFeatures(4), sklm.Ridge())
xlift = dflift.ix.values.reshape(-1,1)
y = dflift.NbCas
modelnblift.fit(xlift, y)
scorenblift = modelnblift.score(xlift,y)
modeldclift = pipe.make_pipeline(pp.PolynomialFeatures(4), sklm.Ridge())
y = dflift.DC
...
modelnbc = pipe.make_pipeline(pp.PolynomialFeatures(4), sklm.Ridge())
xc = dfc.ix.values.reshape(-1,1)
y = dfc.NbCas
modelnbc.fit(xc, y)
scorenbc = modelnbc.score(xc,y)
modeldcc = pipe.make_pipeline(pp.PolynomialFeatures(4), sklm.Ridge())
y = dfc.DC
modeldcc.fit(xc, y)
